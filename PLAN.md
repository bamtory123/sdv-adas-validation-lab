...
1. Download the selected external PASCAL VOC 2012 source and run the VOC fixture builder plus the ONNX/TensorRT label-evaluation CLI on a documented subset.
