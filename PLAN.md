...
1. Define a larger sample-size policy and hold-out split before considering release interpretation; retain the current 50-image result as repeatability evidence only.
