...
- Unit tests: 28 passed plus 2 opt-in local GPU smoke tests on 2026-08-28.
...
Add larger licensed replay coverage and ground-truth accuracy KPI before treating the runtime/delay matrix as final release evidence.
