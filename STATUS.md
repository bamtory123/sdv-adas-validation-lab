...
- Unit tests: 31 passed plus 2 opt-in local GPU smoke tests on 2026-08-28.
...
Select a labeled, license-cleared replay source and class mapping, then connect ground-truth accuracy to the FCN run artifacts.
